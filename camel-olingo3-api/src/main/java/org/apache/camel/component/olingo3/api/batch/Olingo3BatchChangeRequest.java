 ...
 */
package org.apache.camel.component.olingo3.api.batch;
 ...
 * Batch Change part.
 */
public class Olingo3BatchChangeRequest extends Olingo3BatchRequest {
    ...
    public static class Olingo4BatchChangeRequestBuilder {
        ...
        private Olingo3BatchChangeRequest request = new Olingo3BatchChangeRequest();
        ...
        public Olingo3BatchChangeRequest build() {
            // avoid later NPEs
