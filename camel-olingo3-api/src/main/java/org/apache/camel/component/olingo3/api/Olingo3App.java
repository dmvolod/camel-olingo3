 ...
 */
package org.apache.camel.component.olingo3.api;
...
public interface Olingo3App {
     ...
     * @param queryParams OData query parameters
     * @param endpointHttpHeaders HTTP Headers to add/override the component versions
     * @param responseHandler callback handler
     * @return Return typed object
     */
    <T> void read(Edm edm, String resourcePath, Map<String, String> queryParams, Map<String, String> endpointHttpHeaders, Olingo3ResponseHandler<T> responseHandler);
     ...
     * @param responseHandler callback handler
     */
    void uread(Edm edm, String resourcePath, Map<String, String> queryParams, Map<String, String> endpointHttpHeaders, Olingo3ResponseHandler<InputStream> responseHandler);
     ...
     */
    void delete(String resourcePath, Map<String, String> endpointHttpHeaders, Olingo3ResponseHandler<HttpStatusCode> responseHandler);
     ...
     * @param responseHandler callback handler
     */
    <T> void create(Edm edm, String resourcePath, Map<String, String> endpointHttpHeaders, Object data, Olingo3ResponseHandler<T> responseHandler);
     ...
     */
    <T> void update(Edm edm, String resourcePath, Map<String, String> endpointHttpHeaders, Object data, Olingo3ResponseHandler<T> responseHandler);
     ...
     * @param responseHandler {@link org.apache.olingo.client.api.domain.ClientEntity} callback handler
     */
    <T> void patch(Edm edm, String resourcePath, Map<String, String> endpointHttpHeaders, Object data, Olingo3ResponseHandler<T> responseHandler);
     ...
     * @param responseHandler {@link org.apache.olingo.client.api.domain.ClientEntity} callback handler
     */
    <T> void merge(Edm edm, String resourcePath, Map<String, String> endpointHttpHeaders, Object data, Olingo3ResponseHandler<T> responseHandler);

    /**
     * Executes a batch request.
     * @param edm service Edm
     * @param endpointHttpHeaders HTTP Headers to add/override the component versions
     * @param data ordered {@link org.apache.camel.component.olingo4.Olingo3BatchRequest.batch.Olingo4BatchRequest} list
     * @param responseHandler callback handler
     */
    void batch(Edm edm, Map<String, String> endpointHttpHeaders, Object data, Olingo3ResponseHandler<List<Olingo3BatchResponse>> responseHandler);
}
