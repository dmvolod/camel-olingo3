 ...
 * Batch Query part.
 */
public class Olingo3BatchQueryRequest extends Olingo3BatchRequest {
    ...
    public static class Olingo4BatchQueryRequestBuilder {
        private Olingo3BatchQueryRequest request = new Olingo3BatchQueryRequest();

        public Olingo3BatchQueryRequest build() {
            // avoid later NPEs
